...
║                      XRP TICKER                          ║
╠════════════════════════════╦═════════════════════════════╣
║    XRP/USD • Coinbase      ║     Portfolio • XRPL        ║
║       $ 2.4523             ║  BALANCE:    1,234.56 XRP   ║
║    ▲ +0.0234 (+0.96%)      ║  VALUE:      $3,025.89      ║
╠════════════════════════════╩═════════════════════════════╣
║ 24h High  │ 24h Low   │ 24h Change │ 24h Volume          ║
║ $2.5124   │ $2.3891   │ +0.96%     │ 45.2M XRP           ║
╠══════════════════════════════════════════════════════════╣
║          ⣀⣤⣶⣿⣿⣶⣤⣀⣀⣤⣶⣿⣿⣶⣤⣀⣀⣤⣶⣿⣿⣶⣤⣀                ║
╚══════════════════════════════════════════════════════════╝
```
